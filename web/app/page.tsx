...
export default function ConnectionWizardPage() {
  ...
  const renderStepContent = () => {
    switch (currentStep) {
      ...
      case 'stage_1_whatsapp_type':
        return (
          <div className="space-y-8 animate-fadeIn">
            <h2 className="text-2xl font-bold text-gray-900 text-center">O número de WhatsApp que você gostaria de conectar está em um:</h2>
            ...
            <div className="grid gap-4 max-w-lg mx-auto">
              ...
              >
                ...
                <div>
                  <span className="block text-lg font-bold text-gray-900">WhatsApp Business (profissional)</span>
              ...
              >
                ...
                <div>
                  <span className="block text-lg font-bold text-gray-900">WhatsApp Comum (pessoal)</span>
            ...
            <div className="bg-red-50 p-8 rounded-2xl border border-red-100">
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="w-full py-4 bg-white text-gray-700 font-medium rounded-xl border border-gray-200 hover:bg-gray-50 transition-colors"
                >
        ...
        return (
          <div className="space-y-6 text-center animate-fadeIn max-w-xl mx-auto">
            <div className="bg-blue-50 p-8 rounded-2xl border border-blue-100">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Nesse caso te ajudaremos com isso.</h2>
              ...
              <a
                ...
                className="inline-block w-full py-4 bg-green-600 text-white font-bold rounded-xl hover:bg-green-700 transition-colors"
              >
                Abrir Chat de Suporte Agora
              </a>
            </div>
            <button onClick={() => goToStep('stage_2_no_computer')} className="text-gray-500 hover:text-gray-800 underline">Voltar</button>
          </div>
        );
      ...
      case 'stage_2_computer_no_mobile':
        return (
          <div className="space-y-6 text-center animate-fadeIn max-w-xl mx-auto">
            <h2 className="text-2xl font-bold text-gray-900">É preciso que você esteja com o aparelho onde está o WhatsApp Business (profissional) em mãos para continuar a conexão.</h2>
            <div className="grid gap-3 pt-4">
              ...
              {showMobileWarning && (
                <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-xl text-yellow-800 text-sm animate-pulse">
      ...
      case 'stage_2_tablet_check':
        return (
          <div className="space-y-6 text-center animate-fadeIn max-w-xl mx-auto">
            <h2 className="text-2xl font-bold text-gray-900">O WhatsApp Business (profissional) que você quer conectar está neste Tablet/iPad?</h2>
            <div className="grid gap-3 pt-4">
              <button
        ...
        return (
          <div className="space-y-8 animate-fadeIn max-w-xl mx-auto">
            ...
            <div className="space-y-4">
              ...
              >
                <span className="block text-xl font-bold text-gray-900 mb-1">Sim, mas <strong>não</strong> para esse número que desejo conectar</span>
                <span className="text-gray-600">Faço anúncios para outro número</span>
              </button>
              ...
              >
                <span className="block text-xl font-bold text-blue-900 mb-1">Sim, faço anúncios para este número que desejo conectar</span>
                <span className="text-blue-700">Os anúncios são direcionados para esse número específico</span>
              </button>
              ...
              <button
                ...
                className="w-full p-5 border-2 border-gray-100 bg-white rounded-xl text-left hover:border-gray-400 hover:bg-gray-50 transition-all group"
              >
                <span className="block text-xl font-bold text-gray-900 mb-1">Não rodo tráfego pago para nenhum número</span>
                <span className="text-gray-600">Não faço anúncios</span>
              </button>
            </div>
            <button onClick={() => goToStep('stage_2_os_selection')} className="block mx-auto text-gray-500 hover:text-gray-800 underline mt-6">Voltar</button>
          </div>
        );
        ...
        return (
          <div className="space-y-6 text-center animate-fadeIn max-w-xl mx-auto">
            <div className="bg-green-50 p-6 rounded-2xl border border-green-100 mb-6">
              <h3 className="text-xl font-bold text-green-900 mb-2">Você pode usar <strong>qualquer conta do Facebook</strong> para fazer a conexão, entenda:</h3>
        ...
        return (
          <div className="space-y-8 animate-fadeIn max-w-xl mx-auto">
            <div className="text-center">
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Acesso ao Facebook/Meta Ads Obrigatório</h2>
            ...
            <div className="space-y-4">
              ...
              >
                <span className="font-bold text-red-900">Não tenho acesso, com certeza</span>
      ...
      case 'stage_3_meta_lost_access':
        return (
          <div className="space-y-6 animate-fadeIn max-w-2xl mx-auto">
            ...
            <div className="bg-blue-50 p-6 rounded-xl border-l-4 border-blue-400 text-left">
              <p className="font-semibold text-blue-900 mb-1">💡 Essa conta pertence ao seu Gestor de Tráfego?</p>
              <p className="text-sm text-blue-800">Entre em contato com ele para recuperar o acesso.</p>
            </div>

            <div className="space-y-4">
              <button
                onClick={() => goToStep('step_inside_system')}
                className="w-full p-5 border-2 border-green-100 bg-green-50 rounded-xl text-left hover:border-green-400 hover:bg-green-100 transition-all"
              >
                <span className="font-bold text-green-900">Consegui a conta de volta</span>
              </button>
              ...
              <button
                ...
                className="w-full p-5 border-2 border-red-100 bg-red-50 rounded-xl text-left hover:border-red-400 hover:bg-red-100 transition-all"
              >
                <span className="font-bold text-red-900">Acredito que perdi essa conta do Facebook para sempre</span>
                <p className="text-sm text-red-700 mt-1">Ainda há esperança. Veja o que você pode fazer.</p>
              </button>
            </div>
            <button onClick={() => goToStep('stage_3_meta_access_check')} className="block mx-auto text-gray-500 hover:text-gray-800 underline mt-6">Voltar</button>
          </div>
        );
      ...
      case 'stage_3_meta_lost_access_options':
        return (
          <div className="space-y-6 animate-fadeIn max-w-2xl mx-auto">
            <h2 className="text-2xl font-bold text-gray-900 text-center">Ainda Há Esperança!</h2>

            <div className="bg-gray-50 p-6 rounded-xl space-y-6 text-gray-700">
              <div>
                <h3 className="font-bold text-lg text-gray-900 mb-2">Tentativa 1 (Simples):</h3>
              ...
              <div>
                <h3 className="font-bold text-lg text-gray-900 mb-2">Tentativa 2 (Avançada):</h3>
                <p className="mb-3">Para desvincular esse número do seu Facebook que não tem mais acesso você deve:</p>
                ...
                <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200 mt-4">
                  <p className="text-yellow-800 text-sm"><strong>💡 Resultado:</strong> Isso "desvincula" o número da conta perdida do Facebook à força. E o torna livre para conectar em qualquer conta de Facebook.</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid gap-4">
              <button
                ...
                className="w-full p-4 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 text-sm"
              >
              ...
              <button
                onClick={() => goToStep('step_inside_system')}
                className="w-full p-4 border-2 border-green-500 bg-green-50 text-green-800 rounded-xl font-bold hover:bg-green-100 text-sm"
              >
        ...
        return (
          <div className="space-y-8 animate-fadeIn max-w-xl mx-auto text-center">
            <div className="bg-green-50 p-8 rounded-2xl border border-green-100">
              <div className="text-5xl mb-4">✅</div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Ótimo! Migração Concluída</h2>
              <p className="text-gray-600 mb-6">
            ...
            <button onClick={() => goToStep('stage_3_meta_lost_access_options')} className="text-gray-500 hover:text-gray-800 underline">Voltar</button>
          </div>
        );
      ...
      case 'step_inside_system':
        ...
        return (
          ...
          <div className="space-y-8 text-center animate-fadeIn max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold text-gray-900">Dentro do Sistema</h2>
            <p className="text-lg text-gray-600">no menu lateral clique em Conexão WhatsApp</p>

            {/* Steps List */}
            <div className="space-y-8">
              {slides.map((slide, index) => (
                <div key={index} className="bg-white rounded-2xl border-2 border-gray-200 overflow-hidden p-8">
                  {/* Subtitle */}
                  <p className="text-sm text-gray-600 mb-3">{slide.subtitle}</p>

                  {/* Title */}
                  <h3 className="text-xl font-bold text-gray-900 mb-6">{slide.title}</h3>
                  ...
                  <div className="bg-gray-100 rounded-xl overflow-hidden">
                    <img
                      ...
                      onError={(e) => {
                        ...
                        (e.target as HTMLImageElement).parentElement!.innerHTML = '<div class="flex items-center justify-center p-8"><span class="text-gray-500">📷 Imagem: ' + slide.image + '</span></div>';
                      }}
                    />
                  </div>
                </div>
        ...
        return (
          <div className="space-y-6 text-center animate-fadeIn max-w-2xl mx-auto">
            <div className="flex flex-col items-center justify-center gap-2 mb-6">
              <AppleIcon />
              <h2 className="text-2xl font-bold text-gray-900">Feche as guias do Facebook (Macbook)</h2>
            </div>
            ...
            <div className="space-y-3 text-left">
              <h3 className="text-lg font-bold text-gray-900">Feche todas as guias do Facebook antes de clicar no botão verde de conectar:</h3>
              <p className="text-sm text-gray-600">Na parte superior do navegador, verifique se já não tem uma guia de conexão aberta:</p>
              <div className="bg-gray-100 rounded-xl overflow-hidden">
                <img
                  src="/close-all.png"
                  ...
                  onError={(e) => {
                    (e.target as HTMLImageElement).style.display = 'none';
                    (e.target as HTMLImageElement).parentElement!.innerHTML = '<div class="flex items-center justify-center p-8"><span class="text-gray-500">📷 Imagem: /close-all.png</span></div>';
                  }}
                />
              </div>
            </div>
            ...
            {/* Mac-specific image */}
            <div className="space-y-3 text-left">
              <p className="text-sm text-gray-600">Olha também na parte inferior da sua tela clicando com o botão direito (sem mouse: dois dedos ao mesmo tempo) em cima do navegador, e você pode encontrar guias de conexão do Facebook, abra uma por uma e feche-as:</p>
              <div className="bg-gray-100 rounded-xl overflow-hidden">
                <img
                  src="/close-mac.png"
                  ...
                  onError={(e) => {
                    (e.target as HTMLImageElement).style.display = 'none';
                    (e.target as HTMLImageElement).parentElement!.innerHTML = '<div class="flex items-center justify-center p-8"><span class="text-gray-500">📷 Imagem: /close-mac.png</span></div>';
                  }}
                />
              </div>
            </div>
            ...
            <button onClick={() => goToStep('step_inside_system')} className="text-gray-500 hover:text-gray-800 underline">Voltar</button>
          </div>
        );
      ...
      case 'step_check_tabs_windows':
        return (
          <div className="space-y-6 text-center animate-fadeIn max-w-2xl mx-auto">
            <div className="flex flex-col items-center justify-center gap-2 mb-6">
              <WindowsIcon />
              <h2 className="text-2xl font-bold text-gray-900">Feche as guias do Facebook (Windows/Outro)</h2>
            </div>
            ...
            <div className="space-y-3 text-left">
              <p className="text-sm text-gray-600">Na parte inferior da tela do seu computador, você colocando o mouse por cima do navegador pode encontrar outras guias do Facebook. Feche-as também:</p>
              <div className="bg-gray-100 rounded-xl overflow-hidden">
                <img
                  src="/close-wind.jpg"
                  ...
                  onError={(e) => {
                    (e.target as HTMLImageElement).style.display = 'none';
                    (e.target as HTMLImageElement).parentElement!.innerHTML = '<div class="flex items-center justify-center p-8"><span class="text-gray-500">📷 Imagem: /close-wind.jpg</span></div>';
                  }}
                />
              </div>
            </div>
      ...
      case 'step_connection_start':
        return (
          <div className="space-y-8 animate-fadeIn max-w-3xl mx-auto py-6 px-4">
            <h2 className="text-2xl font-bold text-gray-900 text-center">Hora de Conectar</h2>

            {/* First section - Click green button */}
            <div className="space-y-4">
              <p className="text-sm text-gray-600 text-center">Com todas as guias do Facebook fechadas</p>
              <h3 className="text-xl font-bold text-gray-900 text-center">No sistema, clique no botão verde: Conectar WhatsApp Business</h3>
              <div className="bg-gray-100 rounded-xl overflow-hidden">
                <img
                  src="/4.png"
                  ...
                  onError={(e) => {
                    (e.target as HTMLImageElement).style.display = 'none';
                    (e.target as HTMLImageElement).parentElement!.innerHTML = '<div class="flex items-center justify-center p-8"><span class="text-gray-500">📷 Imagem: /4.png</span></div>';
                  }}
                />
              </div>
            </div>
            ...
            <div className="space-y-4">
              <p className="text-sm text-gray-600 text-center">Abrirá uma tela de conexão do Facebook</p>
              <h3 className="text-xl font-bold text-gray-900 text-center">Qual dos dois modelos de tela aparece para você:</h3>
              ...
              <div className="grid grid-cols-1 gap-8">
                ...
                >
                  <div className="bg-gray-100 rounded-xl overflow-hidden border-2 border-gray-200 hover:border-blue-500 hover:shadow-lg transition-all cursor-pointer">
                    <h4 className="text-lg font-bold text-gray-800 text-center mt-2">Modelo 1</h4>
                    <img
                      src="/mod-1.png"
                      alt="Modelo 1"
                      className="w-full h-auto"
                      onError={(e) => {
                        (e.target as HTMLImageElement).style.display = 'none';
                        (e.target as HTMLImageElement).parentElement!.innerHTML = '<div class="flex items-center justify-center p-8"><span class="text-gray-500">📷 mod-1.png</span></div>';
                      }}
                    />
                  </div>
                </button>
                ...
                >
                  <div className="bg-gray-100 rounded-xl overflow-hidden border-2 border-gray-200 hover:border-blue-500 hover:shadow-lg transition-all cursor-pointer">
                    <h4 className="text-lg font-bold text-gray-800 text-center mt-2">Modelo 2</h4>
                    <img
                      src="/mod-2.png"
                      alt="Modelo 2"
                      className="w-full h-auto"
                      onError={(e) => {
                        (e.target as HTMLImageElement).style.display = 'none';
                        (e.target as HTMLImageElement).parentElement!.innerHTML = '<div class="flex items-center justify-center p-8"><span class="text-gray-500">📷 mod-2.png</span></div>';
                      }}
                    />
                  </div>
                </button>
              ...
              <div className="pt-4 space-y-3 pb-6">
                <p className="text-center font-medium text-gray-900">Meu caso é o:</p>
      ...
      case 'step_model_1': {
        const model1Slides = [
          ...
          },
          {
            ...
            subtitle: 'Passo 2',
            description: (
              <div className="space-y-4 text-left text-sm text-gray-600 bg-gray-50 p-4 rounded-xl border border-gray-100 max-h-80 overflow-y-auto">
                ...
                <p><strong>Dicas de apoio:</strong></p>
        ...
        return (
          <div className="w-full text-center animate-fadeIn max-w-3xl mx-auto">
            <div className="w-full py-4">
              <p className="text-sm text-gray-500 font-bold tracking-wider uppercase mb-2">{model1Slides[currentSlide].subtitle}</p>
              <h3 className="text-2xl font-bold text-gray-900 mb-6">{model1Slides[currentSlide].title}</h3>
              ...
              <div className="rounded-xl overflow-hidden mb-6 bg-gray-50 border border-gray-100">
                <img
                  ...
                  onError={(e) => {
                    (e.target as HTMLImageElement).style.display = 'none';
                    (e.target as HTMLImageElement).parentElement!.innerHTML = '<div class="flex items-center justify-center p-8"><span class="text-gray-500">📷 Imagem: ' + model1Slides[currentSlide].image + '</span></div>';
                  }}
                />
              </div>
            ...
            <button onClick={() => goToStep('step_connection_start')} className="text-gray-500 hover:text-gray-800 underline text-sm mt-4">Voltar para escolha de modelo</button>
          </div>
        );
      }
      ...
      case 'step_model_2': {
            ...
            description: (
              <div className="space-y-8">
                <button
                  ...
                  className="w-full p-6 rounded-xl border-2 border-gray-200 hover:border-blue-500 hover:bg-blue-50 transition-all"
                >
                  <p className="font-bold text-gray-800 text-xl mb-4">1. Vejo um QR Code</p>
                  <div className="rounded-lg overflow-hidden bg-white">
                    <img src="/qr-code-new0.png" alt="QR Code" className="w-full h-auto" />
                  </div>
                </button>
                ...
                <button
                  ...
                  className="w-full p-6 rounded-xl border-2 border-gray-200 hover:border-blue-500 hover:bg-blue-50 transition-all"
                >
                  <p className="font-bold text-gray-800 text-xl mb-4">2. Vejo essa tela para adicionar número</p>
                  <div className="rounded-lg overflow-hidden bg-white">
                    <img src="/mod2-new0.png" alt="Tela adicionar número" className="w-full h-auto" />
                  </div>
                </button>
              </div>
            )
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4 justify-center">
                  <button
                    ...
                    className="px-6 py-3 rounded-xl font-bold transition-all bg-gray-100 text-gray-600 hover:bg-gray-200 hover:shadow-md"
                  >
                    Sim, recebi
                  </button>
                  <button
        ...
        return (
          <div className="w-full text-center animate-fadeIn max-w-3xl mx-auto">
            <div className="w-full py-4">
              <p className="text-sm text-gray-500 font-bold tracking-wider uppercase mb-2">{model2Slides[currentSlide].subtitle}</p>
              <h3 className="text-2xl font-bold text-gray-900 mb-6">{model2Slides[currentSlide].title}</h3>

              {/* Image Container - Handles single or dual images (hidden for slide 4 which has images in buttons) */}
              {currentSlide !== 4 && (
                <div className={`rounded-xl overflow-hidden mb-6 bg-gray-50 border border-gray-100 ${'secondaryImage' in model2Slides[currentSlide] ? 'grid grid-cols-2 gap-2' : ''}`}>
                  <img
                    ...
                    onError={(e) => {
                      (e.target as HTMLImageElement).style.display = 'none';
                      (e.target as HTMLImageElement).parentElement!.innerHTML = '<div class="flex items-center justify-center p-8"><span class="text-gray-500">📷 ' + model2Slides[currentSlide].image + '</span></div>';
                    }}
                  />
                  {'secondaryImage' in model2Slides[currentSlide] && (
                    <img
                      ...
                      (e.target as HTMLImageElement).style.display = 'none';
                      // @ts-ignore
                      (e.target as HTMLImageElement).parentElement!.innerHTML += '<div class="flex items-center justify-center p-8"><span class="text-gray-500">📷 ' + model2Slides[currentSlide].secondaryImage + '</span></div>';
                    }}
                  />
                )}
                </div>
      ...
      case 'step_model_2_sim': {
        return (
          <div className="w-full text-center animate-fadeIn max-w-3xl mx-auto">
            <div className="w-full py-4">
              <p className="text-sm text-gray-500 font-bold tracking-wider uppercase mb-2">Sim - Recebi</p>
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Como ler o QR code</h3>
              
              {/* Descrição única */}
              <div className="bg-blue-50 p-6 rounded-xl border border-blue-100 text-left mb-6">
              ...
              <div className="grid grid-cols-3 gap-4 mb-6">
                <div className="rounded-xl overflow-hidden bg-gray-50 border border-gray-100">
                  <img 
                    ...
                    onError={(e) => { 
                      (e.target as HTMLImageElement).style.display = 'none'; 
                      (e.target as HTMLImageElement).parentElement!.innerHTML = '<div class="flex items-center justify-center p-8"><span class="text-gray-500">📷 qr-code.png</span></div>'; 
                    }} 
                  />
                </div>
                <div className="rounded-xl overflow-hidden bg-gray-50 border border-gray-100">
                  <img 
                    ...
                    onError={(e) => { 
                      (e.target as HTMLImageElement).style.display = 'none'; 
                      (e.target as HTMLImageElement).parentElement!.innerHTML = '<div class="flex items-center justify-center p-8"><span class="text-gray-500">📷 scan-qr.png</span></div>'; 
                    }} 
                  />
                </div>
                <div className="rounded-xl overflow-hidden bg-gray-50 border border-gray-100">
                  <img 
                    ...
                    onError={(e) => { 
                      (e.target as HTMLImageElement).style.display = 'none'; 
                      (e.target as HTMLImageElement).parentElement!.innerHTML = '<div class="flex items-center justify-center p-8"><span class="text-gray-500">📷 scan-qr2.png</span></div>'; 
                    }} 
                  />
                </div>
              </div>
          ...
          <div className="w-full text-center animate-fadeIn max-w-3xl mx-auto">
            <div className="w-full py-4">
              ...
              <div className="flex items-center justify-center gap-3 mb-4">
                <AppleIcon />
                <div>
                  <p className="text-sm text-gray-500 font-bold tracking-wider uppercase">Não Recebi (iPhone)</p>
                  <h3 className="text-2xl font-bold text-gray-900">Modo iPhone</h3>
                </div>
              </div>

              <p className="text-sm text-gray-500 font-bold mb-6">{iphoneSlides[currentSlide].subtitle}</p>

              <div className="mb-6">
                <button onClick={() => goToStep('step_model_2_nao_android')} className="text-sm text-blue-600 hover:text-blue-800 underline">Na verdade meu aparelho é Android</button>
              </div>
                  ...
                  <div key={index} className="space-y-3">
                    ...
                    <div className="rounded-xl overflow-hidden bg-gray-50 border border-gray-100">
                      <img 
                        ...
                        onError={(e) => { 
                          (e.target as HTMLImageElement).style.display = 'none'; 
                          (e.target as HTMLImageElement).parentElement!.innerHTML = '<div class="flex items-center justify-center p-8"><span class="text-gray-500 text-xs">📷 ' + image + '</span></div>'; 
                        }} 
                      />
                    </div>
                  </div>
          ...
          <div className="w-full text-center animate-fadeIn max-w-3xl mx-auto">
            <div className="w-full py-4">
              ...
              <div className="flex items-center justify-center gap-3 mb-4">
                <AndroidIcon />
                <div>
                  <p className="text-sm text-gray-500 font-bold tracking-wider uppercase">Não Recebi (Android)</p>
                  <h3 className="text-2xl font-bold text-gray-900">Modo Android</h3>
                </div>
              </div>

              <p className="text-sm text-gray-500 font-bold mb-6">{androidSlides[currentSlide].subtitle}</p>

              <div className="mb-6">
                <button onClick={() => goToStep('step_model_2_nao_iphone')} className="text-sm text-blue-600 hover:text-blue-800 underline">Na verdade meu aparelho é iPhone</button>
              </div>

              {/* Grid de imagens (1 ou 2 dependendo da etapa) */}
              <div className={`grid gap-6 mb-8 ${androidSlides[currentSlide].images.length === 1 ? 'grid-cols-1 max-w-md mx-auto' : 'grid-cols-1 md:grid-cols-2'}`}>
      ...
      case 'step_model_2_novo_numero': {
        ...
        return (
          <div className="w-full text-center animate-fadeIn max-w-3xl mx-auto">
            <div className="w-full py-4">
              <p className="text-sm text-gray-500 font-bold tracking-wider uppercase mb-2">{novoNumeroSlides[currentSlide].subtitle}</p>
              <h3 className="text-2xl font-bold text-gray-900 mb-6">{novoNumeroSlides[currentSlide].title}</h3>

              {/* Grid de imagens */}
              <div className={`grid gap-6 mb-8 ${novoNumeroSlides[currentSlide].images.length === 1 ? 'grid-cols-1 max-w-md mx-auto' : 'grid-cols-1 md:grid-cols-2'}`}>
      ...
      case 'step_model_2_fuso': {
        return (
          <div className="w-full text-center animate-fadeIn max-w-3xl mx-auto">
            <div className="w-full py-4">
              <p className="text-sm text-gray-500 font-bold tracking-wider uppercase mb-2">Passo 7</p>
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Fuso Horário</h3>
              ...
              <div className="rounded-xl overflow-hidden mb-6 bg-gray-50 border border-gray-100">
                <img src="/fuso-horario.png" alt="Fuso Horário" className="w-full h-auto" onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; (e.target as HTMLImageElement).parentElement!.innerHTML = '<div class="flex items-center justify-center p-8"><span class="text-gray-500">📷 /fuso-horario.png</span></div>'; }} />
              </div>
              <div className="grid gap-3 mt-8">
                <button onClick={() => goToStep('step_model_2_conclusao')} className="w-full py-4 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 transition-colors shadow-lg">Próxima etapa</button>
                <button onClick={() => goToStep(cameFromModel1 ? 'step_model_1' : 'step_model_2')} className="w-full py-3 text-gray-500 hover:text-gray-800 font-medium transition-colors">
      ...
      case 'step_model_2_conclusao': {
        return (
          <div className="w-full text-center animate-fadeIn max-w-3xl mx-auto">
            <div className="w-full py-4">
              <p className="text-sm text-gray-500 font-bold tracking-wider uppercase mb-2">Passo 8</p>
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Conclusão</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div className="rounded-xl overflow-hidden bg-gray-50 border border-gray-100">
                  <img 
                    ...
                    onError={(e) => { 
                      (e.target as HTMLImageElement).style.display = 'none'; 
                      (e.target as HTMLImageElement).parentElement!.innerHTML = '<div class="flex items-center justify-center p-8"><span class="text-gray-500">📷 /conectando.png</span></div>'; 
                    }} 
                  />
                </div>
                <div className="rounded-xl overflow-hidden bg-gray-50 border border-gray-100">
                  <img 
                    ...
                    onError={(e) => { 
                      (e.target as HTMLImageElement).style.display = 'none'; 
                      (e.target as HTMLImageElement).parentElement!.innerHTML = '<div class="flex items-center justify-center p-8"><span class="text-gray-500">📷 /concluir.png</span></div>'; 
                    }} 
                  />
                </div>
              </div>
              <div className="grid gap-3 mt-8">
                <button onClick={() => window.location.reload()} className="w-full py-4 bg-green-600 text-white font-bold rounded-xl hover:bg-green-700 transition-colors shadow-lg">Concluir</button>
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-900 flex flex-col justify-center">
      {/* Main Content */}
